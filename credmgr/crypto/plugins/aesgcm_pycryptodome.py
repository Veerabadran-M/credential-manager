...
A second AES-GCM implementation, distinct from aesgcm_cryptography.py. This
exists mainly to demonstrate that the plugin system supports multiple
backends implementing the *same* algorithm under different names/libraries
-- useful on platforms where 'cryptography' is hard to build (e.g. it needs
a Rust toolchain) but a pure-C extension like PyCryptodome is easier.
"""
