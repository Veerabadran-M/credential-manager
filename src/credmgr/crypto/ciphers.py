...
A uniform interface so the rest of the codebase never talks to a
specific crypto library directly. To add a cipher: implement
generate_key/encrypt/decrypt plus name/key_size/nonce_size, and register
the class in CIPHERS.
"""
