"""Exceptions shared by the crypto backend interface, plugin registry,
and every plugin implementation.

Callers outside this package only need to catch these, never a
library-specific exception -- plugins translate whatever their
underlying library raises into one of these.
"""
